...
// який викликає цей метод.
// padBoth(str) — отримує параметр str (рядок) і додає його на початок і в кінець значення приватної властивості value
...
class StringBuilder {
  ...
  // додавання str в кінець value
  padEnd(str) {
    this.#value += str;
  }

  //додавання str на початок value
  padStart(str) {
    this.#value = str + this.#value;
  }

  //додавання str на початок і в кінець value
  padBoth(str) {
